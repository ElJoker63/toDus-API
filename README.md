...
<ul>
  <li><strong>Versión:</strong> 1.5.0</li>
...
# Cambiar el @username (todus_id)
# NOTA: el nombre de usuario no puede contener espacios ni el prefijo '@'
client.set_todus_id("MiNuevoUsername")
</code></pre>
